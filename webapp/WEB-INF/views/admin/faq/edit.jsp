...
<form name="form1" method="post" action="${pageContext.servletContext.contextPath }/admin/faq/edit">
...
<table width="600" border="1" cellspacing="0" bordercolordark="white" bordercolorlight="black">
	<tr> 
		...
		<td width="500" height="20"  bgcolor="#F2F2F2">
			<input type="text" name="title" value="${faq.title }" size="67">
		</td>
	</tr>
	<tr> 
		<td width="100" height="20" bgcolor="#CCCCCC" align="center">
		...
		<td width="500" height="20" bgcolor="#F2F2F2">
			<textarea name="content" rows="7" cols="69">${faq.content }</textarea>
		</td>
	</tr>
</table>
<br>
