...
<table width="500" border="0" cellspacing="0" cellpadding="0">
	<tr height="50">
		<td align="left"  width="300" valign="bottom">&nbsp 옵션명 : <font color="#0457A2"><b>${option.name }</b></font></td>
...
<table width="500" border="1" cellspacing="0" bordercolordark="white" bordercolorlight="black">
	...
	<tr bgcolor="#F2F2F2" height="20">	
		<td width="100" align="center">${suboption.no }</td>
		<td width="300" align="left">${suboption.name }</td>
		<td width="100" align="center">
			<a href="../option/${option.no }/suboption/edit/${suboption.no }">수정</a>/
			<a href="">삭제</a>
		</td>
	</tr>
	</c:forEach>
