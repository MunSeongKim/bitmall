...
<hr width='900' size='3'>
<form name="search-order-form" method="GET" action="${pageContext.servletContext.contextPath }/admin/order/search">
<table width="800" border="0" cellspacing="0" cellpadding="0">
	<tr height="40">
		<td align="left"  width="100" valign="bottom">&nbsp 주문수 : <font color="#FF0000">${fn:length(orders)}</font></td>
