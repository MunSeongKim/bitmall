...
<!-------------------------------------------------------------------------------------------->	
			...
			<table border="0" cellpadding="0" cellspacing="0" width="690" class="cmfont">
				...
				<tr height="25" bgcolor="#FFFFFF">	
					<td width="90" align="center"><font color="#686868">${size-status.index }</font></td>	
					<td><a href="${pageContext.servletContext.contextPath }/faq/${faq.no}"><font color="#686868">${faq.title }</font></a></td>	
				</tr>
				</c:forEach>
