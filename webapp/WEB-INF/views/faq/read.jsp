...
<!-------------------------------------------------------------------------------------------->	
			...
			<table border="0" cellpadding="0" cellspacing="0" width="690">
				...
				<tr>
					...
					<td width="586" class="cmfont">${faq.title }</td>
				</tr>
				<tr><td colspan="2" height="2"></td></tr>
				...
				<tr>
					...
					<td width="586" height="50" class="cmfont">
						<p style="padding-left:5px;padding-top:5px;padding-right:5px;padding-bottom:5px;">${ fn:replace(faq.content, newLine, "<br />") }</p>
					</td>
				</tr>
				<tr><td colspan="2" height="2"></td></tr>
			</table>
			...
			<table border="0" cellpadding="0" cellspacing="0" width="690">
				<tr>
					<td align="right">
						<a href="${pageContext.servletContext.contextPath }/faq"><img src="${pageContext.servletContext.contextPath }/assets/images/b_list.gif" border="0"></a>
					</td>
				</tr>
			</table>
