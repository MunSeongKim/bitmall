...
function SendZip() 
{
	...
	var targetForm = opener.document.getElementsByName('order-index-form')[0];
	if (zip_kind==1)			
	{
		targetForm.orderZipcode[0].value = zip1;
		targetForm.orderZipcode[1].value = zip2;
		targetForm.orderAddress.value = juso;
	} else if (zip_kind==2)	{
		targetForm.rcvZipcode[0].value = zip1;
		targetForm.rcvZipcode[1].value = zip2;
		targetForm.rcvAddress.value = juso;
	} else {
		opener.document.getElementById("input-zip1").value = zip1;
		opener.document.getElementById("input-zip2").value = zip2;
		opener.document.getElementById("input-address").value = juso;
	}
...
<table width="500" border="0"cellpadding="0"cellspacing="0">
	...
	<tr height="55"> 
		<td align="center">
			<a id="send-zip" href="javascript:SendZip()"><img src="/assets/images/b_ok1.gif" border="0"></a>
		</td>
	</tr>
</form>
</table>
