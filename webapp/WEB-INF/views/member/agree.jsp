			...
			<table id="content-user-item">
				<tr>
					<td id="content-user-subtitle" class="cmfont">
						<img src="${pageContext.servletContext.contextPath }/assets/images/login_title1.gif" />
					</td>
				</tr>
				<tr>
					<td class="content-user-form cmfont">
...
②“몰”과 이용자간에 제기된 전자상거래 소송에는 한국법을 적용합니다.
				...
				<tr>
					<td class="actions">
						<a href="javascript:CheckAgree()"><img src="${pageContext.servletContext.contextPath }/assets/images/b_agreeok.gif" /></a> 
						<a href="${pageContext.servletContext.contextPath }"><img src="${pageContext.servletContext.contextPath }/assets/images/b_agreeno.gif" /></a>
					</td>
				</tr>
			</table>
		<!-------------------------------------------------------------------------------------------->	
